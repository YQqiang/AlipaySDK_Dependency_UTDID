#
# Be sure to run `pod lib lint AlipaySDK_Dependency_UTDID.podspec' to ensure this is a
...
适用于集成了阿里推送(AlicloudPush)，出现 UTDID 冲突的情况.
  ...
  s.homepage         = 'https://github.com/YQqiang/AlipaySDK_Dependency_UTDID'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'yuqiang' => 'yuqiang.coder@gmail.com' }
  s.source           = { :git => 'https://github.com/YQqiang/AlipaySDK_Dependency_UTDID.git', :tag => s.version.to_s }
  ...
  s.source_files = 'AlipaySDK_Dependency_UTDID/Classes/**/*'
  
  # s.resource_bundles = {
  #   'AlipaySDK_Dependency_UTDID' => ['AlipaySDK_Dependency_UTDID/Assets/*.png']
  # }
